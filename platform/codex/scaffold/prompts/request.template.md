...
4. only if they explicitly agree, bootstrap with `ax run-request --request "<request>" --allow-missing-global-context`
5. otherwise bootstrap with `ax run-request --request "<request>"`
