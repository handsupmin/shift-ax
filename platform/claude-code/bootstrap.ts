...
export function renderClaudeCodeSessionStartContext(rootDir: string, locale: ShiftAxLocale = 'en'): string {
...
export function renderClaudeCodeBootstrap(rootDir: string, locale: ShiftAxLocale = 'en'): string {
  return renderTemplate('platform/claude-code/scaffold/CLAUDE.template.md', rootDir, locale);
}

export function getClaudeCodeBootstrapAssets(rootDir: string, locale: ShiftAxLocale = 'en'): ShiftAxBootstrapAsset[] {
