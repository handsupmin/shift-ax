...
첫 실행에서 onboarding artifact가 없으면, Shift AX는 먼저 플랫폼 세션을 열고 그 안에서 언어 선택과 guided onboarding을 진행합니다. 별도의 readline 기반 질문 단계로 먼저 빠지지 않습니다.
...
첫 실행에서는 플랫폼 세션 안에서 언어를 먼저 묻고, repo가 아직 onboard되지 않았다면 같은 대화 안에서 guided onboarding을 진행합니다.
