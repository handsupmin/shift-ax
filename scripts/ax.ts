...
const commands = new Map<string, string>([
  ...
  ['update', 'ax-update.ts'],
  ['refresh-runtime', 'ax-refresh-runtime.ts'],
...
if (versionCommands.has(command ?? '')) {
  ...
  process.stderr.write(
    [
      ...
      '  shift-ax update [--root DIR] [--platform <codex|claude-code|both>] [--lang en|ko]',
      ...
      '  shift-ax refresh-runtime [--root DIR] [--platform <codex|claude-code|both>] [--lang en|ko]',
