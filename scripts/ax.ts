...
if (shellMode) {
  ...
  process.stderr.write(
    [
      ...
      '  ax  # default launcher (Codex unless global settings choose another platform)',
      '',
      'Commands:',
      ...
      '  ax onboard-context [--input FILE] [--discover] [--overwrite] [--lang en|ko] [--platform <codex|claude-code>] [--root DIR]',
      '  ax export-context',
      '  ax doctor [--root DIR] [--topic DIR] [--platform <codex|claude-code>]',
      '  ax run-request --request "<text>" [--summary "<text>"] [--brainstorm-file PATH] [--spec-file PATH] [--plan-file PATH] [--index PATH] [--allow-missing-global-context] [--root DIR] [--base BRANCH]  # interactive planning by default',
