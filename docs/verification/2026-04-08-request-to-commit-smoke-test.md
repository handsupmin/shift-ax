...
4. record human plan approval
5. resume with automated review
6. auto-commit after the review gate passes

## Temporary Repo

- Temp repo root: `/var/folders/3t/gfy8tm3558sgzwgk8q10qkhc0000gn/T/tmp.gT1YmLKI0z`
- Topic directory: `/var/folders/3t/gfy8tm3558sgzwgk8q10qkhc0000gn/T/tmp.gT1YmLKI0z/.ax/topics/2026-04-07-build-safer-auth-refresh-flow`
- Worktree directory: `/var/folders/3t/gfy8tm3558sgzwgk8q10qkhc0000gn/T/tmp.gT1YmLKI0z/.ax/worktrees/2026-04-07-build-safer-auth-refresh-flow`

## Commands Run

```bash
npm --silent run ax -- onboard-context --root "/var/folders/3t/gfy8tm3558sgzwgk8q10qkhc0000gn/T/tmp.gT1YmLKI0z" --input "/var/folders/3t/gfy8tm3558sgzwgk8q10qkhc0000gn/T/tmp.gT1YmLKI0z/onboarding.json"
printf '%s\n'   'Users should stay signed in during refresh token rotation.'   'Auth policy applies and no schema changes are allowed.'   'Do not change billing or the session UI.'   'Verification needs auth refresh tests plus a clean build.'   'Auth refresh service, token store, and session middleware.'   'Token store migration analysis is the only long-running slice.'   '' | npm --silent run ax -- run-request --root "/var/folders/3t/gfy8tm3558sgzwgk8q10qkhc0000gn/T/tmp.gT1YmLKI0z" --request 'Build safer auth refresh flow'
npm --silent run ax -- approve-plan --topic "/var/folders/3t/gfy8tm3558sgzwgk8q10qkhc0000gn/T/tmp.gT1YmLKI0z/.ax/topics/2026-04-07-build-safer-auth-refresh-flow" --reviewer "Alex Reviewer" --decision approve
npm --silent run ax -- run-request --topic "/var/folders/3t/gfy8tm3558sgzwgk8q10qkhc0000gn/T/tmp.gT1YmLKI0z/.ax/topics/2026-04-07-build-safer-auth-refresh-flow" --resume --verify-command 'node --test auth-refresh.test.js'
```
...
```json
{
  ...
  "index": {
    "indexPath": "/var/folders/3t/gfy8tm3558sgzwgk8q10qkhc0000gn/T/tmp.gT1YmLKI0z/docs/base-context/index.md",
    "entries": [
      {
        "label": "Auth policy",
        "path": "docs/base-context/auth-policy.md"
  ...
  "profile": {
    "version": 1,
    "updated_at": "2026-04-07T16:32:10.608Z",
...
```json
{
  ...
  "topicDir": "/var/folders/3t/gfy8tm3558sgzwgk8q10qkhc0000gn/T/tmp.gT1YmLKI0z/.ax/topics/2026-04-07-build-safer-auth-refresh-flow",
  "metadata": {
    "version": 1,
    "topic_slug": "2026-04-07-build-safer-auth-refresh-flow",
    "created_at": "2026-04-07T16:32:10.979Z",
    "status": "bootstrapped",
    "artifacts": {
      "request": "request.md",
  ...
  "resolvedContext": {
    "version": 1,
    "index_path": "/var/folders/3t/gfy8tm3558sgzwgk8q10qkhc0000gn/T/tmp.gT1YmLKI0z/docs/base-context/index.md",
    "query": "Build safer auth refresh flow",
    "matches": [
      {
        "label": "Auth policy",
        "path": "docs/base-context/auth-policy.md",
        "absolute_path": "/var/folders/3t/gfy8tm3558sgzwgk8q10qkhc0000gn/T/tmp.gT1YmLKI0z/docs/base-context/auth-policy.md",
        "score": 1,
  ...
  "worktree": {
    ...
    "worktree_path": "/var/folders/3t/gfy8tm3558sgzwgk8q10qkhc0000gn/T/tmp.gT1YmLKI0z/.ax/worktrees/2026-04-07-build-safer-auth-refresh-flow",
    "base_branch": "main",
    "created": true,
    "reused": false
  },
  "workflow": {
    ...
    "created_at": "2026-04-07T16:32:10.979Z",
    "updated_at": "2026-04-07T16:32:10.979Z",
...
```json
{
  ...
  "reviewed_at": "2026-04-07T16:32:11.516Z",
...
```json
{
  "workflow": {
    ...
    "phase": "committed",
    "created_at": "2026-04-07T16:32:10.979Z",
    "updated_at": "2026-04-07T16:32:11.919Z",
    ...
    "verdicts": [
      {
        ...
        "lane": "domain-policy",
        "status": "approved",
        "checked_at": "2026-04-07T16:32:11.987Z",
      ...
      },
      {
        ...
        "status": "approved",
        "checked_at": "2026-04-07T16:32:12.032Z",
  ...
  "finalization": {
    "version": 1,
    "status": "committed",
    "commit_sha": "730188e3be6569523cfd8f6b2fa672a84e3208bb",
    "committed_at": "2026-04-07T16:32:11.919Z",
    "git_cwd": "/var/folders/3t/gfy8tm3558sgzwgk8q10qkhc0000gn/T/tmp.gT1YmLKI0z/.ax/worktrees/2026-04-07-build-safer-auth-refresh-flow",
    "message_path": "/var/folders/3t/gfy8tm3558sgzwgk8q10qkhc0000gn/T/tmp.gT1YmLKI0z/.ax/topics/2026-04-07-build-safer-auth-refresh-flow/final/commit-message.md",
    "review_summary_path": "/var/folders/3t/gfy8tm3558sgzwgk8q10qkhc0000gn/T/tmp.gT1YmLKI0z/.ax/topics/2026-04-07-build-safer-auth-refresh-flow/review/summary.md"
  }
}
```
...
{
  "version": 1,
  "generated_at": "2026-04-07T16:32:10.979Z",
  "topic_slug": "2026-04-07-build-safer-auth-refresh-flow",
...
- final commit SHA: `730188e3be6569523cfd8f6b2fa672a84e3208bb`
