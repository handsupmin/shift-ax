...
- **Observability**
  ...
  - Provide compact operator surfaces such as `shift-ax topic-status` instead of a heavyweight dashboard.
  - Extend that with a compact multi-topic list (`shift-ax topics-status`) before considering any broader dashboard.
